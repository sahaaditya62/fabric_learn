...
Vagrant.configure('2') do |config|
  ...
  # config.vm.synced_folder "C:/Deepak/projects/finaldoc-chaincode/src/com/dappchain/finaldoc", "/home/ubuntu/workspace/finaldoc-chaincode"
  
  
  config.vm.synced_folder ENV.fetch('LOCALDEVDIR', "../.."), "#{LOCALDEV}"
  config.vm.provider :virtualbox do |vb|
    vb.name = "hyperledger1.1"
